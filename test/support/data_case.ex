defmodule RewardApp.DataCase do
  @moduledoc """
  ...
  by setting `use RewardApp.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(RewardApp.Repo, shared: not tags[:async])
